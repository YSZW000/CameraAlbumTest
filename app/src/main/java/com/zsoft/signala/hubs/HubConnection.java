...
public class HubConnection extends ConnectionBase {
    ...
    private final Map<String, HubProxy> mHubs = new HashMap<>();
    private final Map<String, HubInvokeCallback> mCallbacks = new HashMap<>();
    ...
    public HubConnection(String url, Context context, String queryString, ITransport transport) {
